...
/**
 * Main menu panel with dynamic scaling for fullscreen support.
 */
public class MainMenuPanel extends JPanel {
    ...
    public MainMenuPanel(Game game, int screenWidth, int screenHeight) {
        ...
        // Calculate scale factors based on default 800x600
        ...
        newGameButton.setBounds(buttonX, (int)(200 * scaleY), buttonWidth, buttonHeight);
        ...
        aboutUsButton.setBounds(buttonX, (int)(260 * scaleY), buttonWidth, buttonHeight);
        aboutUsButton.addActionListener(e -> game.showScreen("aboutUsScreen"));

        JButton exitButton = UIHelper.createMenuButton("EXIT", scale);
        exitButton.setBounds(buttonX, (int)(320 * scaleY), buttonWidth, buttonHeight);
